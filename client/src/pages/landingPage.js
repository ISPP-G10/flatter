          ...
          >
            <div id="mc_embed_signup_scroll" className="mail-form-container">
              <div className="mail-form-text-column">
                <label htmlFor="mce-EMAIL" className="email-text">
                  ¿Quieres ser de los primeros en probrar Flatter?
                </label>
                <p>
                  Introduce tu correo electrónico para estar al tanto de las
                  nuevas actualizaciones del proyecto y tener la posiblidad de
                  formar parte del grupo de usuarios que tendrán acceso a las
                  primeras versiones
                </p>
              </div>
              <div className="mail-form-input-column">
                <div className="mc-field-group input-email-subscribe">
                  <input
                    type="email"
                    name="EMAIL"
                    className="required email email-input"
                    id="mce-EMAIL"
                ...
                <div
                  id="mce-responses"
                  className="clear foot email-form-control-flags"
                >
                  <div
                    className="response"
                ...
                <div className="optionalParent">
                  <div className="input-subscribe">
                    <input
                      ...
                      className="submit-button button featured"
                    />
                  </div>
                </div>
              </div>
